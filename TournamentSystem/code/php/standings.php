	...
	foreach ($t->getDivisions() as $div) 
		{
			...
			foreach ($div->getSortedTeamStats(array(util::GAMES_WON, SORT_DESC, util::GAMES_LOST, SORT_ASC, util::SCORE_DIFF, SORT_DESC, 'name', SORT_ASC)) as $tm)
				{
					$rank += 1;		
					...
					echo "<td nowrap>",$tm[util::CAPTURES],"&nbsp;</td>";
