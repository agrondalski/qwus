...
echo "<table border=1 cellpadding=2 cellspacing=0>";
echo "<tr>";
echo "<td><font size='2'><a href='?a=addTeam&tourney_id=$tid'>Create a team</a></td>";
echo "<td><font size='2'><a href='?a=listTeams&tourney_id=$tid'>List teams</a></td>";
echo "</tr>";
echo "<tr>";
echo "<td><font size='2'><a href='?a=addPlayer&tourney_id=$tid'>Create a player</a></td>";
echo "<td><font size='2'><a href='?a=listPlayers&tourney_id=$tid'>List players</a></td>";
echo "</tr>";
echo "<tr>";
echo "<td>&nbsp;</td>";
