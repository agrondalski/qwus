...
try
{
  ...
  if ($show_player==1)
    {
      echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=name'>Name</a></th>";
      echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=team_name'>Team</a></th>";
      echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=",util::GAMES_PLAYED,"'>GP</a></th>";
    }
  else
    {
      echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=name'>Name</a></th>";
  ...
  if ($page == 'main')
      ...
      if ($show_player==1)
	{
	  ...
	  echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=",util::SCORE_PER_GAME,"'>S/G</a></th>";
	  ...
	  echo "<th><a href='?a=statistics&amp;tourney_id=$tid&amp;division_id=$division_id&page=$page&amp;map_id=$map_id&amp;show_player=$show_player&amp;sort=",util::SCORE_DIFF,"'>+/-</a></th>";
  ...
  if ($show_player == 1)
  ...
  else
    {
      if ($division_id == "-1") 
	{
	  $arr = $t->getSortedTeamStats(array($sort, $sortOrder, util::SCORE_PER_GAME, SORT_DESC), $map_id);
	}
      else 
	{
	  $arr = $div->getSortedTeamStats(array($sort, $sortOrder, util::SCORE_PER_GAME, SORT_DESC), $map_id);
	}
    }
  ...
  foreach ($arr as $player)
      ...
      if ($show_player==1)
	{
	  ...
	  echo "<td nowrap>",util::nvl($player[util::GAMES_PLAYED],0),"</td>";
	}
      else
	{
	  ...
	  if ($show_player==1)
	    {
	      ...
	      echo "<td nowrap>",util::nvl($player[util::SCORE_DIFF],0),"</td>";
