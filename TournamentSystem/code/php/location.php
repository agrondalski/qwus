...
class location
{
  ...
  function __construct($a)
      ...
      if (isset($id) && is_numeric($id))
	{
      ...
      $this->country_name  = mysql_real_escape_string($a['country_name']) ;
      $this->state_name    = mysql_real_escape_string($a['state_name']) ;
      $this->logo_url      = mysql_real_escape_string($a['logo_url']) ;
